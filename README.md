...
This is the repository for the arena server for the SAP Labs CEE Hub Programming Competition 2023. The [public documentation](https://github.com/afarago/SLCEE-2023-PC-public) of the competition were made accessible to teams in the respective repository during the competition, while this repository will be shared only afterwards to help teams keep focus.
...
The environment variable approach enables easy change without keeping the hardcoded secrets in the code itself <sup>(1)</sup>.
...
---
<sup>(1)</sup> Need to research how to keep app.yaml effectively separate, yet under versioned source control. Currently secrets are still shared.